...
#    rcParams.update(params)
    ...
    plt.plot(range(len(result['accuracy_test_bit_1.0'])),result['accuracy_test_bit_1.0'],label=r'bit=1')
    plt.plot(range(len(result['accuracy_test_bit_2.0'])), result['accuracy_test_bit_2.0'],label=r'bit=2')
...
def plot_figure(result,num1,num2):
    ...
    return result['accuracy_test'][len1-1],result['accuracy_test_bit_1.0'][len1-1],\
result['accuracy_test_bit_2.0'][len1-1],result['accuracy_test_bit_3.0'][len1-1],\
result['accuracy_test_bit_inf'][len1-1]
...
if __name__ == '__main__':
    ...
    for m in range(len(M_set)):
        mm=M_set[m]
        filename='./store/discrete_trial_{}_M_{}_N_{}_L_{}_\
...
#            res_CNN_MB[item]=copy.deepcopy(res_CNN_MB[item]/trial)
        ...
        a,b,c,d,e=plot_figure(res_CNN,3,4)
#        a2,b2,c2,d2,e2=plot_figure(res_CNN_MB,5,6)
